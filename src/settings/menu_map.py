menu_map = {
    'main': {
        ...
        'items': [
            ...
            {'type':'button', 'action': 'nav', 'target': 'ball', 'object': None, 'text': 'Ball', 'icon':'ball_green', 'condition':0},
            {'type':'button', 'action': 'nav', 'target': 'bar', 'object': None, 'text': 'Bar', 'icon':'bar', 'condition':0},
            {'type':'button', 'action': 'delete_all_pins', 'target': None, 'object': None, 'text': 'Remove all pins', 'icon':'pin', 'condition':3},
    ...
    'constraint': {
        ...
        'items': [
            ...
            {'type':'button', 'action': 'nav', 'target': 'damped_spring', 'object': None, 'text': 'Add spring', 'icon':'spring',  'condition':0},
            {'type':'button', 'action': 'add', 'target': 'pin_joint', 'object': None, 'text': 'Add pin joint', 'icon':'constraint',  'condition':0},
            {'type':'button', 'action': 'add', 'target': 'pivot_joint', 'object': None, 'text': 'Add pivot joint', 'icon':'pivot',  'condition':0},
    ...
    'ball': {
        ...
        'items': [
            ...
            {'type':'button', 'action': 'add', 'target': 'ball', 'object': None, 'text': 'Add ball', 'icon':'ball_green', 'condition':7},
            ...
            {'type':'button', 'action': 'nav', 'target': 'bar', 'object': None, 'text': 'Add bar', 'icon':'bar', 'condition':7},
            {'type':'button', 'action': 'add', 'target': 'ball', 'object': None, 'text': 'Add new ball', 'icon':'ball_green', 'condition':1},
            ...
            {'type':'button', 'action': 'delete', 'target': None, 'object': None, 'text': 'Delete selected', 'icon':'bin', 'condition':1},
            {'type':'button', 'action': 'delete_constraints', 'target': None, 'object': None, 'text': 'Delete constraints', 'icon':'constraint', 'condition':4},
            {'type':'button', 'action': 'delete_selected_pins', 'target': None, 'object': None, 'text': 'Delete pins', 'icon':'pin', 'condition':5},
    ...
    'bar': {
        ...
        'items': [
            ...
            {'type':'text', 'text':'Add item', 'object':None, 'condition': 7},
            {'type':'button', 'action': 'nav', 'target': 'ball', 'object': None, 'text': 'Add ball', 'icon':'ball_green', 'condition':7},
            {'type':'button', 'action': 'add', 'target': 'bar', 'object': None, 'text': 'Add bar', 'icon':'bar', 'condition':7},
            {'type':'input', 'input':'mass','default_value':1 ,'entry': 'simple', 'condition':0, 'object': None},
            {'type':'input', 'input':'length','default_value':100 ,'entry': 'simple', 'condition':0, 'object': None},
            {'type':'input', 'input':'elasticity','default_value':0.9 ,'entry': 'simple', 'condition':0, 'object': None},
            {'type':'input', 'input':'friction','default_value':0.3,'entry': 'simple', 'condition':0, 'object': None},
            {'type':'button', 'action': 'add', 'target': 'bar', 'object': None, 'text': 'Add new bar', 'icon':'bar', 'condition':1},
            {'type':'button', 'action': 'nav', 'target': 'constraint', 'object': None, 'text': 'Add constraint', 'icon':'constraint', 'condition':2},
            {'type':'button', 'action': 'nav', 'target': 'motor', 'object': None, 'text': 'Add motor', 'icon':'motor', 'condition':1},
            {'type':'button', 'action': 'delete', 'target': None, 'object': None, 'text': 'Delete selected', 'icon':'bin', 'condition':1},
            {'type':'button', 'action': 'delete_constraints', 'target': None, 'object': None, 'text': 'Delete constraints', 'icon':'constraint', 'condition':4},
    ...
    'damped_spring': {
        ...
        'items': [
            ...
            {'type':'button', 'action': 'add', 'target': 'damped_spring', 'object': None, 'text': 'Add spring', 'icon':'spring', 'condition':2},
            ...
            {'type':'button', 'action': 'delete', 'target': None, 'object': None, 'text': 'Delete selected', 'icon':'pin', 'condition':1},
